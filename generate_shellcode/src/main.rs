...
fn main() {
    ...
    convert_to_shellcode(&mut user_dll, user_dll_size, user_function_hash, user_data, user_data.len() as _, SRDI_CLEARMEMORY, &mut final_shellcode, &mut final_size);
...
//credits: monoxgas
fn convert_to_shellcode(dll_bytes: &mut Vec<u8>, dll_length: usize, user_function: u32, user_data: &str, user_data_length: u32, flags: u32, final_shellcode: &mut Vec<u8>, final_shellcode_length: &mut u32) {
