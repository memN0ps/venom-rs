...
pub unsafe fn copy_sections_to_local_process(module_base: usize) -> *mut c_void { //Vec<u8>
...
pub fn get_exported_functions_by_hash() -> bool {
    ...
    let getprocaddress_address = unsafe { get_export_by_hash(kernel32_base, GET_PROC_ADDRESS_HASH) };
    ...
    let flushinstructioncache_address = unsafe { get_export_by_hash(kernel32_base, FLUSH_INSTRUCTION_CACHE_HASH) };
